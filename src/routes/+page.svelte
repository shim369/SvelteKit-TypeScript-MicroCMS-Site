            ...
            <a href="{content.id}" class="blog-item">
                ...
                <div class="blog-text">
                    <div class="blog-line1">
                        <div class="category">{content.category.name}</div><div class="date"><i class="material-icons schedule-icon">schedule</i>{dayjs(content.publishedAt).format('YYYY.MM.DD')}</div>
                    </div>
